...
namespace restaurant
{
    class RetrivalData
    {
        ...
        public static void getRoles(DataGridView gv,DataGridViewColumn roleIDGV,DataGridViewColumn roleNameGV,DataGridViewColumn roleNumberGV)
        {
            try
            {
                ...
                roleNumberGV.DataPropertyName = dt.Columns["Number"].ToString();
